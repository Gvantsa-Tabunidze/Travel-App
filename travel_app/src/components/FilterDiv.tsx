 ...
 return(
     <Box sx={{ display: "flex", flexDirection:{xs:"column", sm:"row", md:"row"}, gap: 2,  alignItems: "center", flexWrap: "wrap", px:'200px', py:'24px'}}>
      ...
      <FormControl sx={{width:'240px'}} >
        <Select labelId="demo-simple-select-label" id="demo-simple-select" value={region} sx={{height:'40px',  marginTop: 0, marginBottom: 0,}} onChange={(e)=>onRegionChange(e.target.value)}>
